...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        attn_output = attn_output.squeeze(1)  # attn_output 的形状变为 [200, 512]
        return attn_output
...
class AEBase(nn.Module):
    def __init__(self,
        ...
        # self.simple_mha = MultiHeadAttention(input_dim=512, num_heads=8)
    ...
    def encode(self, input: Tensor):
        ...
        # embedding = self.simple_mha(embedding)
        return embedding
...
class Predictor(nn.Module):
    def __init__(self,
        ...
        self.simple_mha = MultiHeadAttention(input_dim=64, num_heads=8)
